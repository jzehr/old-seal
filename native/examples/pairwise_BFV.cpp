...

{
  ...
  */
  ...
  for (int i = 0; i < 1; i++) {
    ...
    /*
    We now subtract the second (plaintext2 (input2)) matrix to the encrypted one
    using another new operation hxb2 - ref
    */
    // need to save this as an object to iterate over so that no one can see the
    // decrypted results
    cout << "Subtracting: ";
    cout << endl;
